...
manifest.set_requiredStatement(label="Attribution",value="Provided by University of Verona and Biblioteca Capitolare di Verona",language_l="en",language_v="en")
