...
manifest.set_id(extendbase_url="navdate_map_1-manifest.json")
manifest.add_label("en","1987 Chesapeake and Ohio Canal, Washington, D.C., Maryland, West Virginia, official map and guide")
manifest.set_navDate("1987-01-01T00:00:00+00:00")
...
if __name__ == "__main__":
    manifest.json_save("0230-navdate-navdate_map_1-manifest.json")