...
homp = iiifpapi3.hompage()
homp.set_id()
homp.set_type("Text")
homp.set_type("Text")
homp.add_label("en","Example Organization Hompage")
...
homp2 =iiifpapi3.hompage()
homp2.set_id("https://example.org/info/book1/")
homp2.set_type("Text")
homp2.add_label("en","Hompage for Book 1")
homp2.set_format("text/html")
manifest.add_hompage(homp2)
...
data = (("p. 1",750,1000,"https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f18","/full/max/0/default.jpg","annotation"),
        ("p. 2",750,1000,"https://iiif.io/api/image/3.0/example/reference/59d09e6773341f28ea166e9f3c1e674f-gallica_ark_12148_bpt6k1526005v_f19","/full/max/0/default.jpg",False),
        )
