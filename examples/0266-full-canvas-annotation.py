# implementation of Image and Canvas with Differing Dimensions https://iiif.io/api/cookbook/recipe/0266-full-canvas-annotation/
from IIIFpres import iiifpapi3
iiifpapi3.BASE_URL = r"https://iiif.io/api/cookbook/recipe/0266-full-canvas-annotation/" 
...
canvasannopage.set_id(extendbase_url="canvas-1/annopage-2")
annotation2 = canvasannopage.add_annotation_to_items(target=canvas.id) 
annotation2.set_motivation("commenting")
annotation2.set_id(extendbase_url="canvas-1/annopage-2/anno-1")
annotation2.body.set_format("text/plain")
annotation2.body.set_type("TextualBody")
annotation2.body.set_value("Göttinger Marktplatz mit Gänseliesel Brunnen")
