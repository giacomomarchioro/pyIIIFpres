...
iiifpapi3.BASE_URL = "https://iiif.io/api/cookbook/recipe/0202-start-canvas"
manifest = iiifpapi3.Manifest()
manifest.set_id(extendbase_url="manifest.json")
manifest.add_label("en","Multiple Related Images (Book, etc.)")
manifest.set_start()
manifest.start.set_type("Canvas")
manifest.start.set_id("https://iiif.io/api/cookbook/recipe/0202-start-canvas/canvas/p2")
...
if __name__ == "__main__":
    manifest.json_save("0202-start-canvas_manifest.json")