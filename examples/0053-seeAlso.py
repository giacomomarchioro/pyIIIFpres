...
iiifpapi3.BASE_URL = "https://iiif.io/api/cookbook/recipe/0053-seeAlso"
manifest = iiifpapi3.Manifest()
manifest.set_id(extendbase_url="manifest.json")
manifest.add_label("en","Linking to Structured Metadata")
...
SeeAl = manifest.add_seeAlso()
SeeAl.set_id('https://fixtures.iiif.io/other/UCLA/ezukushi_mods.xml')
SeeAl.set_type('Dataset')
SeeAl.add_label("en","MODS metadata")
SeeAl.set_format("text/xml")
SeeAl.set_profile("http://www.loc.gov/mods/v3")
...
if __name__ == "__main__":
    manifest.json_save("0053-seeAlso_manifest.json")