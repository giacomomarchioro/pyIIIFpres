    ...
    def test_raising_error_objid_and_extendbaseURL(self):
        ...
        with self.assertRaises(ValueError):
            self.manifest.set_id(
                objid=iiifpapi3.BASE_URL, extendbase_url=iiifpapi3.BASE_URL
            )
...
class TestManifest(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertEqual(
            repr(self.manifest),
            "Manifest id:https://iiif.io/api/cookbook/recipe/0004-canvas-size/manifest.json",
        )
...
class Test_required_recommended_and_optionals(unittest.TestCase):
    ...
    def test_label(self):
        self.assertEqual(
            ...
            Required("https://iiif.io/api/presentation/3.0/#label"),
        )
        self.assertEqual(
            self.Manifest.label, Required("https://iiif.io/api/presentation/3.0/#label")
        )
        self.assertEqual(
            self.Range.label, Recommended("https://iiif.io/api/presentation/3.0/#label")
        )
        self.assertEqual(
            self.Canvas.label,
            Recommended("https://iiif.io/api/presentation/3.0/#label"),
        )
        self.assertEqual(
            self.AnnotationCollection.label,
            Recommended("https://iiif.io/api/presentation/3.0/#label"),
        )
    ...
    def test_metadata(self):
        self.assertEqual(
            ...
            Recommended("https://iiif.io/api/presentation/3.0/#metadata"),
        )
        self.assertEqual(
    ...
    def test_summary(self):
        self.assertEqual(
            ...
            Recommended("https://iiif.io/api/presentation/3.0/#summary"),
        )
        self.assertEqual(
    ...
    def test_provider(self):
        self.assertEqual(
            ...
            Recommended("https://iiif.io/api/presentation/3.0/#provider"),
        )
        self.assertEqual(
    ...
    def test_thumbnail(self):
        self.assertEqual(
            ...
            Recommended("https://iiif.io/api/presentation/3.0/#thumbnail"),
        )
        self.assertEqual(
            self.Manifest.thumbnail,
            Recommended("https://iiif.io/api/presentation/3.0/#thumbnail"),
        )
    ...
    def test_add_to_items_return(self):
        self.assertTrue(
            isinstance(self.Collection.add_collection_to_items(), iiifpapi3.Collection)
        )
        self.assertTrue(
            isinstance(self.Collection.add_manifest_to_items(), iiifpapi3.refManifest)
        )
        self.assertTrue(
            isinstance(self.Manifest.add_canvas_to_items(), iiifpapi3.Canvas)
        )
        self.assertTrue(
            isinstance(
                self.Canvas.add_annotationpage_to_items(), iiifpapi3.AnnotationPage
            )
        )
        self.assertTrue(
            isinstance(
                self.AnnotationPage.add_annotation_to_items(), iiifpapi3.Annotation
            )
        )
